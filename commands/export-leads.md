---
name: export-leads
description: Export research results to JSON or CSV format
argument-hint: [json|csv] [output-file]
allowed-tools: Read, Write, Bash
---

Export gathered research data to specified format: $ARGUMENTS
...
Default filenames:
- JSON: `prospect-export-[timestamp].json`
- CSV: `prospect-export-[timestamp].csv`

### Step 2: Gather Available Data

Check conversation context for:
- Recent `/research-contact` results
- Recent `/research-company` results
- Recent `/enrich-batch` results
- Any research gathered via natural language queries

If no recent research data found:
- Inform user: "No recent research data to export."
- Suggest: "Run /research-contact or /research-company first, then export."
...
person,John Smith,john@acme.com,95,+1-555-1234,linkedin.com/in/jsmith,@jsmith,VP Engineering,Acme Corp,San Francisco,8,,,,2026-02-08
company,Acme Corp,jane@acme.com (CEO),95,+1-555-0000,,,,,San Francisco,,Software,250-500,acme.com,2026-02-08
```
...
4. Continue researching more prospects
